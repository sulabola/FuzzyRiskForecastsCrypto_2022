...
```{r}
# download Apple
getSymbols("ADA-USD", from = '2019-11-25',
...
data<- merge (`ADA-USD`$`ADA-USD.Adjusted`, Return.calculate(`ADA-USD`$`ADA-USD.Adjusted`, method = "log"), Return.calculate(`ADA-USD`$`ADA-USD.Adjusted`, method = "difference"))
...
```{r}
getSymbols("ADA-USD", from = '2019-08-01',
           to = "2021-11-06",warnings = FALSE,
           auto.assign = TRUE)
nrow(`ADA-USD`)
ADA.Price<-`ADA-USD`[, 6]
plot(ADA.Price, col = "blue")
```
